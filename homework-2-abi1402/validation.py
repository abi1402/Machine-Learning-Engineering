...
def signature_unchanged(fn, *args, **kwargs):
    ...
    if fn.__name__ == "evaluate_test":
        def evaluate_test(X_train, y_train, X_eval, y_eval):
            ...
            """
            pass
        _check_signature(evaluate_test, fn)
    if fn.__name__ == "few_shot_learning":
        def few_shot_learning(X_train, y_train, X_eval, y_eval):
            ...
            """
            pass
        _check_signature(few_shot_learning, fn)
    ...
    if fn.__name__ == "plot_sparse_character_coefficients":
        def plot_sparse_character_coefficients(X, y, character):
            pass
        _check_signature(plot_sparse_character_coefficients, fn)
